...
import { PRIVACY_SECTIONS } from "./legalData";
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="border-b border-slate-200 pb-6 mb-8">
          ...
          <p className="text-sm text-slate-500">
            Dernière mise à jour : 15 août 2026 &bull; Conforme RGPD (UE 2016/679) &bull; Hébergement 100% UE (Supabase Francfort)
          </p>
        </div>
        ...
        <div className="relative mb-8">
          ...
          <input
            ...
            placeholder="Rechercher une clause de confidentialité (ex: DPO, cookies, effacement)..."
